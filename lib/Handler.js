...
class Handler extends HandlerInterface_1.HandlerInterface {
    ...
    { track, encodings, codecOptions, codec }) {
        ...
        const sendingRtpParameters = utils.clone(this._sendingRtpParametersByKind[track.kind], null);
        // This may throw.
    ...
    async pauseReceiving(localId) {
        logger.debug('pauseReceiving received. Does not have implementation');
        return;
    }
    async resumeReceiving(localId) {
        logger.debug('resumeReceiving received. Does not have implementation');
        return;
    }
